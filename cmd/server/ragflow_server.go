...
func main() {
	...
	dao.DB.AutoMigrate(&dao.TenantLLM{}, &dao.User{}, &dao.Tenant{}, &dao.UserTenant{}, &dao.Dataset{}, &dao.Document{}, &dao.DocumentTask{}, &dao.DocumentChunk{}, &dao.AgentCanvas{}, &dao.ChatSession{}, &dao.ChatMessage{})
