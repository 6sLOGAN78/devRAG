...
5. **Go Engine Backend**: Inspect Go server in [internal/server/server.go:L40](file:///home/logan78/Desktop/ragflow/internal/server/server.go#L40) and Go canvas engine in [internal/agent/canvas/canvas.go:L80](file:///home/logan78/Desktop/ragflow/internal/agent/canvas/canvas.go#L80).

---

## Hands-On Milestones

- **Milestone 1**: Implement a custom Agent Canvas component class in `agent/component/custom_node.py` and register it in `agent/component/__init__.py`.
